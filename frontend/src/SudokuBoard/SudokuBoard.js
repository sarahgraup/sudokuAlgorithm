...
const StyledTableCell = styled(TableCell)(({ theme, borderRight, borderBottom }) => ({
...
function SudokuBoard({ board, highlightedCell }) {
    ...
    return (
        <Table className="SudokuBoard" style={{ maxWidth: 450, margin: 'auto', borderCollapse: 'collapse' }}>
            <TableBody>
